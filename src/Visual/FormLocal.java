...
public class FormLocal extends javax.swing.JDialog
{
    ...
    private void trataEdicao(boolean editando)
    {
        ...
        txtestado.setEditable(editando);
    ...
    private void initComponents()
    {
        ...
        listobjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Local>())
        ;
        ...
        txtcidade.setBackground(new java.awt.Color(218, 218, 218));
        txtcidade.setForeground(new java.awt.Color(51, 51, 51));
        txtcidade.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(8, 77, 110), 1, true));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cidade}"), txtcidade, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        txtestado.setBackground(new java.awt.Color(218, 218, 218));
        txtestado.setForeground(new java.awt.Color(51, 51, 51));
        txtestado.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(8, 77, 110), 1, true));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.estado}"), txtestado, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    {//GEN-HEADEREND:event_btnexcluirActionPerformed
        ...
        {
            int linhaSelecionada = tblobjetos.getSelectedRow();
            Local obj = listobjetos.get(linhaSelecionada);
            dao.remover(obj);
            atualizaTabela();
        }
    ...
    {//GEN-HEADEREND:event_btnsalvarActionPerformed
        if (validaCampos())
        {
            ...
            Local obj = listobjetos.get(linhaSelecianada);
            dao.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
        }
    ...
    {//GEN-HEADEREND:event_btnnovoActionPerformed
        listobjetos.add((Local) new Local());
        int linha = listobjetos.size() - 1;
        tblobjetos.setRowSelectionInterval(linha, linha);
        txtcidade.requestFocus();
        trataEdicao(true);
    ...
    private java.util.List<Local> listobjetos;
