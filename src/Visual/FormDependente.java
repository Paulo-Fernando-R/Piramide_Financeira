 ...
 * @author ferna
 */
public class FormDependente extends javax.swing.JDialog
{
     ...
     */
    public FormDependente(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        atualizaTabela();
        ...
        listpessoa.clear();
        listpessoa.addAll(daopessoa.getLista());
    ...
    private void initComponents()
    {
        ...
        listobjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Dependente>())
        ;
        listpessoa = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Pessoa>());
        ...
        cbxpessoa.setForeground(new java.awt.Color(255, 255, 255));

        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listpessoa, cbxpessoa);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.p1}"), cbxpessoa, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);

        cbxlocal.setForeground(new java.awt.Color(255, 255, 255));

        jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listlocal, cbxlocal);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.l1}"), cbxlocal, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
        ...
        abadadosLayout.setHorizontalGroup(
            ...
            .addGroup(abadadosLayout.createSequentialGroup()
                ...
                .addGap(25, 25, 25)
                .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbxpessoa, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cbxlocal, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(70, 70, 70))
        );
    ...
    {//GEN-HEADEREND:event_btnnovoActionPerformed
        listobjetos.add((Dependente) new Dependente());
        int linha = listobjetos.size() - 1;
        tblobjetos.setRowSelectionInterval(linha, linha);
        txtnome.requestFocus();
        trataEdicao(true);
    ...
    {//GEN-HEADEREND:event_btnsalvarActionPerformed
        if (validaCampos())
        {
            ...
            Dependente obj = listobjetos.get(linhaSelecianada);
            dao.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
        }
    ...
    {//GEN-HEADEREND:event_btnexcluirActionPerformed
        ...
        {
            int linhaSelecionada = tblobjetos.getSelectedRow();
            Dependente obj = listobjetos.get(linhaSelecionada);
            dao.remover(obj);
            atualizaTabela();
        }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(FormDependente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                FormDependente dialog = new FormDependente(new javax.swing.JFrame(), true);
    ...
    private java.util.List<Dependente> listobjetos;
