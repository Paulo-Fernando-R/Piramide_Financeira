...
public class FormPessoa extends javax.swing.JDialog
{
    ...
    DAOEsquema daoesquema = new DAOEsquema();
    ...
    private void trataEdicao(boolean editando)
    {
        ...
        txtganho.setEditable(editando);
        txtnivel.setEditable(editando);
        tblobjetos.setEnabled(!editando);
        cbxcaraacima.setEnabled(editando);
        cbxesquema.setEnabled(editando);
    ...
    public boolean validaCampos()
    {
        ...
        if ((txtganho.getText().length() > 0))
        {
            try
            {
                Double.parseDouble(txtganho.getText());
            } catch (Exception e)
            {
                JOptionPane.showMessageDialog(null, "Insira um valor");
                txtganho.requestFocus();
                return false;
            }
        ...
        if ((txtnivel.getText().length() > 0))
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "Insira o nível");
        ...
        if (!(cbxesquema.getSelectedIndex() >= 0))
        {
            JOptionPane.showMessageDialog(null, "Informe o esquema");
            cbxesquema.requestFocus();
            return false;
        }
    ...
    public FormPessoa(java.awt.Frame parent, boolean modal)
    {
        ...
        listesquema.clear();
        listesquema.addAll(daoesquema.getLista());
    ...
    private void initComponents()
    {
        ...
        listesquema = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Esquema>())
        ;
        ...
        txtganho = new javax.swing.JTextField();
        txtcpf = new javax.swing.JTextField();
        cbxcaraacima = new javax.swing.JComboBox<>();
        jLabel7 = new javax.swing.JLabel();
        cbxesquema = new javax.swing.JComboBox<>();
        ...
        abas.setBackground(new java.awt.Color(8, 77, 110));
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${ganho}"));
        columnBinding.setColumnName("Ganho");
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${cara_acima}"));
        columnBinding.setColumnName("Cara_acima");
        columnBinding.setColumnClass(Modelo.Pessoa.class);
        ...
        columnBinding.setColumnName("Esquema");
        columnBinding.setColumnClass(Modelo.Esquema.class);
        ...
        txtnivel.setBackground(new java.awt.Color(218, 218, 218));
        txtnivel.setForeground(new java.awt.Color(51, 51, 51));
        txtnivel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(8, 77, 110), 1, true));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nivel}"), txtnivel, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        txtganho.setBackground(new java.awt.Color(218, 218, 218));
        txtganho.setForeground(new java.awt.Color(51, 51, 51));
        txtganho.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(8, 77, 110), 1, true));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.ganho}"), txtganho, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        txtcpf.setBackground(new java.awt.Color(218, 218, 218));
        txtcpf.setForeground(new java.awt.Color(51, 51, 51));
        txtcpf.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(8, 77, 110), 1, true));
        ...
        cbxcaraacima.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        cbxcaraacima.setForeground(new java.awt.Color(255, 255, 255));
        cbxcaraacima.setBorder(null);

        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listobjetos, cbxcaraacima);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cara_acima}"), cbxcaraacima, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
        ...
        cbxesquema.setForeground(new java.awt.Color(255, 255, 255));

        jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listesquema, cbxesquema);
        bindingGroup.addBinding(jComboBoxBinding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblobjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.e1}"), cbxesquema, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
            ...
            .addGroup(abadadosLayout.createSequentialGroup()
                ...
                .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(abadadosLayout.createSequentialGroup()
                        ...
                        .addComponent(cbxesquema, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(abadadosLayout.createSequentialGroup()
                        .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(19, 19, 19)
                        .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cbxcaraacima, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtganho, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(abadadosLayout.createSequentialGroup()
                ...
                .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(abadadosLayout.createSequentialGroup()
                        .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                            .addComponent(txtganho, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                        ...
                        .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(cbxcaraacima, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(5, 5, 5)))
                .addGap(30, 30, 30)
                .addGroup(abadadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel8)
                    .addComponent(jLabel7)
                    .addComponent(cbxesquema, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    {//GEN-HEADEREND:event_btnsalvarActionPerformed
        if (validaCampos())
        {
            ...
            Pessoa obj = listobjetos.get(linhaSelecianada);
            dao.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
        }
    ...
    private javax.swing.JComboBox<String> cbxcaraacima;
    private javax.swing.JComboBox<String> cbxesquema;
